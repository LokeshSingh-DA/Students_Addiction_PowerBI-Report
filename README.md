...
- Add a risk funnel: **Total Students → High Usage → High Addiction → Academic Impact**.
- Use a scatter chart for usage versus addiction score, colored by academic-impact status.
- Use sorted bar charts for platforms and countries; limit long lists to Top N plus “Other.”
- Apply conditional formatting to flag high addiction scores, low sleep, and reported academic impact.
